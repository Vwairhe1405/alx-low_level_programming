...
int wildcmp(char *s1, char *s2)
{
	...
	/**
	 * if we reach the end of s1 and the char in s2
	 * is a *
	 ...
	 * finds the address of the first char after
	 * the *
...
/**
 * bandersnatch - checks recursively for all the paths
...
int bandersnatch(char *s1, char *s2)
{
	 ...
	 * if chars are equal, return the return value
	 * of wildcmp()
